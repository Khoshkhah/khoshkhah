...
| [**roadstyle**](https://github.com/khoshkhah/roadstyle) | OSM-style road cartography for GeoDataFrames — self-contained interactive MapLibre maps with grade separation, 3D bridge decks, embedded vector tiles and a scriptable JS API. On PyPI: `pip install roadstyle`. | MapLibre, GeoPandas, PMTiles, Python |
